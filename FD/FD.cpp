...
// FD.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CFDApp
CFDApp theApp;

// инициализация CFDApp
...
{
	CDialogEx::DoDataExchange(pDX); //сопоставление данных
}
